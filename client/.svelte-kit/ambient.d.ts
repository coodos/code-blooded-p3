...
declare module '$env/static/private' {
	export const npm_package_devDependencies__storybook_testing_library: string;
	...
	export const npm_package_devDependencies__storybook_builder_vite: string;
	export const npm_package_devDependencies__storybook_addon_interactions: string;
	export const npm_package_private: string;
	export const npm_config_registry: string;
	export const ZSH: string;
	export const npm_package_readmeFilename: string;
	export const npm_package_dependencies_svelte_json_tree: string;
	export const npm_package_dependencies_svelte_forms: string;
	...
	export const npm_package_devDependencies__storybook_addon_actions: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		npm_package_devDependencies__storybook_testing_library: string;
		...
		npm_package_devDependencies__storybook_builder_vite: string;
		npm_package_devDependencies__storybook_addon_interactions: string;
		npm_package_private: string;
		npm_config_registry: string;
		ZSH: string;
		npm_package_readmeFilename: string;
		npm_package_dependencies_svelte_json_tree: string;
		npm_package_dependencies_svelte_forms: string;
		USER: string;
		...
		npm_package_devDependencies__storybook_addon_actions: string;
